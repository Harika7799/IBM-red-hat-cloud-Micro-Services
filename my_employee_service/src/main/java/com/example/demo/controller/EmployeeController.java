...
public class EmployeeController {
	...
	@ExceptionHandler
	public ResponseEntity<EmployeeErrorResponse> handleBookNotFoundException(EmployeeNotFoundException e) {
	...
	public ResponseEntity<Employee> updateEmployeeByEmployeeId(@PathVariable("employeeId") String employeeId,@RequestBody Employee employee)
	{
		log.info("within put mapping");
		Employee emp=employeeService.updateEmployeeByEmployeeId(employeeId, employee);
		return ResponseEntity.status(HttpStatus.OK).body(emp);
	}
	
	@DeleteMapping("/api/employee/delete/{employeeId}")
	public ResponseEntity<String> deleteByBookId(@PathVariable("employeeId") String employeeId)
	{
